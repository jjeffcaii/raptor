...
import `in`.firedog.raptor.core.impl.DefaultSwapper
import `in`.firedog.raptor.server.vo.ErrorMessage
import `in`.firedog.raptor.server.vo.GroupVO
import `in`.firedog.raptor.server.vo.PostAddress
import `in`.firedog.raptor.server.vo.PostGroup
...
class RaptorServer(private val namespaceManager: NamespaceManager, opts: RaptorOptions) : Runnable {
